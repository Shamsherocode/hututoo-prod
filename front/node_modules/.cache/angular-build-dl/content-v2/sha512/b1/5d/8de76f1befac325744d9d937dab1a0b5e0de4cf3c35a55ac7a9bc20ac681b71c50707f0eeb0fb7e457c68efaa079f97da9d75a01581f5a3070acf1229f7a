  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-pages-module"], {
    ...
    function D8EZ(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(element, http, recaptcha3, auth, router, formBuilder, api, cookies) {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function sendOTP(option) {
            ...
            this.recaptcha3.getToken().then(function (token) {
              var bodydata = {
                channel: option,
              ...
              _this2.api.httpRequest('post', 'users/forgotPassword/step3', bodydata).subscribe(function (result) {
                if (result.isOK) {
                  _this2.message = "";
                  _this2.forgotPassStep = 4;
                  _this2.forgotPassBtnText = 'Submit';
          ...
          value: function submitForgotPassword(model, isValid) {
            ...
            if (isValid) {
              this.loading = true;
              this.recaptcha3.getToken().then(function (token) {
                _this3.deviceID = _this3.auth.getDeviceID();

                if (_this3.forgotPassStep == 1) {
                  var bodydata = {
                  ...
                  _this3.api.httpRequest('post', 'users/forgotPassword/step1', bodydata).subscribe(function (result) {
                    if (result.isOK) {
                      _this3.ques = result.params;
                      _this3.message = "";
                      _this3.forgotPassStep = 2;
                ...
                if (_this3.forgotPassStep == 2) {
                  var _bodydata = {
                    question: _this3.ques[0] + '',
                    captcha: token,
                    deviceID: _this3.deviceID,
                    answer: model.answer
                  };

                  _this3.api.httpRequest('post', 'users/forgotPassword/step2', _bodydata).subscribe(function (result) {
                    if (result.isOK) {
                      _this3.cred = result.params;
                      _this3.message = "";
                      _this3.forgotPassStep = 3;
                      _this3.loading = false;
                      _this3.submitted = false;
                    } else {
                      _this3.message = result.message;
                ...
                if (_this3.forgotPassStep == 3) {
                  _this3.option = Number(model.selectedOption);

                  _this3.sendOTP(_this3.option);
                }

                if (_this3.forgotPassStep == 4) {
                  if (model.newpassword != model.newpassword2) {
                    _this3.message = "Password does not match";
                    _this3.loading = false;
                  } else {
                    var _bodydata2 = {
                      deviceID: _this3.deviceID,
                    ...
                    _this3.api.httpRequest('post', 'users/forgotPassword/step4', _bodydata2).subscribe(function (result) {
                      if (result.isOK) {
                        _this3.message = "";

                        _this3.auth.setToken(result.authData.accessToken);

                        _this3.auth.setRefreshToken(result.authData.refreshToken);
          ...
          value: function forgetUsername(model, isValid) {
            ...
            if (isValid) {
              this.loading = true;
              this.recaptcha3.getToken().then(function (token) {
                if (_this4.forgotUserstep == 1) {
                  var bodydata = {
                    deviceID: _this4.auth.getDeviceID(),
                    captcha: token
                  };

                  _this4.api.httpRequest('post', '/users/' + model.email + '/emails/usernameReminder', bodydata).subscribe(function (result) {
                    if (result.isOK) {
                      _this4.message = "";
                      _this4.loading = false;
                      _this4.forgotUserstep = 2;
                      _this4.forgetUserBtnText = 'Done';
                    } else {
                      _this4.loading = false;
                ...
                if (_this4.forgotUserstep == 2) {
                  _this4.formName = 'login';
                  _this4.loading = false;
                }
              }, function (error) {
                _this4.loading = false;
    ...
    function HBZ(module, __webpack_exports__, __webpack_require__) {
      ...
      var ApiService = /*#__PURE__*/function () {
        ...
        _createClass(ApiService, [{
          ...
          value: function httpRequest(method, url, data) {
            ...
            if (method == 'post') {
              return this.http.post("".concat(environments_environment__WEBPACK_IMPORTED_MODULE_3__["baseUrl"]).concat(url), this.incodeURL, this.apiheader);
            } else if (method == 'put') {} else {
              return this.http.get("".concat(environments_environment__WEBPACK_IMPORTED_MODULE_3__["baseUrl"]).concat(url), this.apiheader);
            }
      ...
      ApiService = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
        providedIn: 'root'
      }), __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])], ApiService);
      /***/
    },
    ...
    /***/
    function assJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function dgmN(module, __webpack_exports__, __webpack_require__) {
      ...
      var _lock_lock_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./lock/lock.component */
      "p1Qj");
      /* harmony import */
      ...
      PagesModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        ...
        declarations: [_login_login_component__WEBPACK_IMPORTED_MODULE_8__["LoginComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_6__["RegisterComponent"], _lock_lock_component__WEBPACK_IMPORTED_MODULE_7__["LockComponent"]]
      })], PagesModule);
      /***/
    },
    ...
    /***/
    function lYjW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function p1Qj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_lock_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      LockComponent.ctorParameters = function () {
        return [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]
        }];
      };

      LockComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'lock-cmp',
        template: _raw_loader_lock_component_html__WEBPACK_IMPORTED_MODULE_0__["default"]
      }), __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]])], LockComponent);
      /***/
    },
          ...
          value: function init(siteKey) {
            ...
            return new Promise(function (resolve, reject) {
              if (_this6.isLoaded) {
                ...
                _this6.siteKey = siteKey;
                var script = document.createElement('script');
                script.innerHTML = '';
                script.src = _this6.baseUrl + "?render=".concat(_this6.siteKey, "&onload=ngRecaptcha3Loaded");
                script.id = "recapthcha-".concat(_this6.scriptId);
                script.async = true;
                script.defer = true;
